...
public class QOrderShop extends EntityPathBase<OrderShop> {
    ...
    public final ListPath<OrderItem, QOrderItem> orderItemsList = this.<OrderItem, QOrderItem>createList("orderItemsList", OrderItem.class, QOrderItem.class, PathInits.DIRECT2);
