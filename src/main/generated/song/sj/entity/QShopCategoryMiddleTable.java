...
public class QShopCategoryMiddleTable extends EntityPathBase<ShopItemCategoryMiddleTable> {
    ...
    public QShopCategoryMiddleTable(Path<? extends ShopItemCategoryMiddleTable> path) {
    ...
    public QShopCategoryMiddleTable(Class<? extends ShopItemCategoryMiddleTable> type, PathMetadata metadata, PathInits inits) {
